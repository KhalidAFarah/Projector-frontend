const RestAPIScript = (props:any) => {
    return (
        <div>
            <p>
            Intro:
                How does Destiny load in your items or those random people in your facinity standing there AFK. How does blitz.gg even when shut off keep track of my headshot percentage in Valorant like i gotta keep to yourself. So how do they do it? Well with (a little something called) REST API
                (vis Destiny 2 på en av planetene med random. Vis full før et valorant spill og start op blitz.gg og vis det.)
                Explanation:
                ...
                This part is more specifically directed at Destiny’s API, where we will speak about how bungie send you the responses.
                ...
                Outro:
                •	Restrictions and limits (for example needing oauth2.0 for moving items maybe show dim?)
                In this case of course we’re not using OAuth2 of course which means that we don’t have permission for certain transaction such as moving weapons in player inventories, which thank cyber security for that wouldn’t want a random guy grieving me mid game.
                ...
                •	Closing thoughts
                •	End of an era (where the channel might be heading & mention the testing and the most popular video)
                Sources:
